            ...
            for (Map.Entry<InetSocketAddress, Channel> entry : cache.entrySet()) {
                ...
                while (tryTimes > 0) {
                    ...
                    YrpcRequest yrpcRequest = YrpcRequest.builder()
                        ...
                        .compressType(CompressorFactory.getCompressor(ZrpcBootstrap.getInstance()
                            .getConfiguration().getCompressType()).getCode())
                        .requestType(RequestType.HEART_BEAT.getId())
                        .serializeType(SerializerFactory.getSerializer(ZrpcBootstrap.getInstance()
                    ...
                    ZrpcBootstrap.PENDING_REQUEST.put(yrpcRequest.getRequestId(), completableFuture);
